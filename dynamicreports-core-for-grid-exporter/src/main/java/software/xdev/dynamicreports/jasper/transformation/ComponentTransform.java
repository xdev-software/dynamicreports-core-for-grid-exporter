...
public class ComponentTransform {
     ...
     * <p>component.</p>
     *
     * @param component a {@link software.xdev.dynamicreports.design.definition.component.DRIDesignComponent} object.
     * @param listType  a {@link software.xdev.dynamicreports.report.constant.ListType} object.
    ...
    private JRDesignElement[] component(final JRDesignElement jrElement, final DRIDesignComponent component, final ListType listType) {
        ...
        if (component.getPrintWhenGroupChanges() != null) {
            jrElement.setPrintWhenGroupChanges(this.accessor.getGroupTransform().getGroup(component.getPrintWhenGroupChanges()));
        }
        ...
        jrElement.setPrintWhenExpression(this.accessor.getExpressionTransform().getExpression(component.getPrintWhenExpression()));
    ...
    private JRDesignElement textField(final DRIDesignTextField textField) {
        ...
        jrTextField.setAnchorNameExpression(this.accessor.getExpressionTransform().getExpression(textField.getAnchorNameExpression()));
        ...
        if (hyperLink != null) {
            jrTextField.setHyperlinkAnchorExpression(this.accessor.getExpressionTransform().getExpression(hyperLink.getAnchorExpression()));
            jrTextField.setHyperlinkPageExpression(this.accessor.getExpressionTransform().getExpression(hyperLink.getPageExpression()));
            jrTextField.setHyperlinkReferenceExpression(this.accessor.getExpressionTransform().getExpression(hyperLink.getReferenceExpression()));
            jrTextField.setHyperlinkTooltipExpression(this.accessor.getExpressionTransform().getExpression(hyperLink.getTooltipExpression()));
        ...
        jrTextField.setPatternExpression(this.accessor.getExpressionTransform().getExpression(textField.getPatternExpression()));
        jrTextField.setHorizontalTextAlign(ConstantTransform.horizontalTextAlignment(textField.getHorizontalTextAlignment()));
        jrTextField.setExpression(this.accessor.getExpressionTransform().getExpression(textField.getValueExpression()));
    ...
    private JRDesignElement image(final DRIDesignImage image) {
        ...
        jrImage.setAnchorNameExpression(this.accessor.getExpressionTransform().getExpression(image.getAnchorNameExpression()));
        ...
        if (hyperLink != null) {
            jrImage.setHyperlinkAnchorExpression(this.accessor.getExpressionTransform().getExpression(hyperLink.getAnchorExpression()));
            jrImage.setHyperlinkPageExpression(this.accessor.getExpressionTransform().getExpression(hyperLink.getPageExpression()));
            jrImage.setHyperlinkReferenceExpression(this.accessor.getExpressionTransform().getExpression(hyperLink.getReferenceExpression()));
            jrImage.setHyperlinkTooltipExpression(this.accessor.getExpressionTransform().getExpression(hyperLink.getTooltipExpression()));
            if (hyperLink.getType() != null) {
                final HyperlinkTypeEnum hyperLinkType = ConstantTransform.hyperLinkType(hyperLink.getType());
                if (hyperLinkType != null) {
    ...
    private JRDesignElement subreport(final DRIDesignSubreport subreport, final Integer width) {
        ...
        jrSubreport.setConnectionExpression(this.accessor.getExpressionTransform().getExpression(subreport.getConnectionExpression()));
        jrSubreport.setDataSourceExpression(this.accessor.getExpressionTransform().getExpression(subreport.getDataSourceExpression()));
        ...
        if (ReportBuilder.class.isAssignableFrom(subreport.getReportExpression().getValueClass())) {
            ...
            jrSubreport.setParametersMapExpression(this.accessor.getExpressionTransform().getExpression(parametersExpression));
        } else {
            jrSubreport.setExpression(this.accessor.getExpressionTransform().getExpression(subreport.getReportExpression()));
    ...
    private JRDesignElement map(final DRIDesignMap map) {
        ...
        jrMap.setLongitudeExpression(this.accessor.getExpressionTransform().getExpression(map.getLongitudeExpression()));
    ...
    private JRDesignElement customComponent(final DRIDesignComponent component) {
        ...
        @SuppressWarnings("unchecked") final JRDesignComponentElement jrComponent = (JRDesignComponentElement) componentTransfom.jasperComponent(
