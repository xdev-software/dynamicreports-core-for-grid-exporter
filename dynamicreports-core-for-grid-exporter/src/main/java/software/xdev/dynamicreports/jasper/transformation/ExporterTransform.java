...
public class ExporterTransform
{
	...
	private JRPdfExporter pdf(final JasperIPdfExporter jasperExporter)
	{
		...
		{
			reportExportConfiguration.setCollapseMissingBookmarkLevels(
				jasperExporter.getCollapseMissingBookmarkLevels());
		}
		...
		{
			exporterConfiguration.setPdfaConformance(
				ConstantTransform.pdfaConformance(jasperExporter.getPdfaConformance()));
		}
		...
		final JasperIExcelExporter jasperExporter)
	{
		...
		{
			reportExportConfiguration.setRemoveEmptySpaceBetweenColumns(
				jasperExporter.getRemoveEmptySpaceBetweenColumns());
		}
		if(jasperExporter.getWhitePageBackground() != null)
		{
			reportExportConfiguration.setWhitePageBackground(jasperExporter.getWhitePageBackground());
		...
		{
			reportExportConfiguration.setSheetDirection(
				ConstantTransform.runDirection(jasperExporter.getSheetDirection()));
		}
		...
		{
			reportExportConfiguration.setImageAnchorType(
				ConstantTransform.imageAnchorType(jasperExporter.getImageAnchorType()));
		}
	}
