...
public final class DataTypes
{
	...
	public static <U, T extends DRIDataType<? super U, U>> T detectType(final Class<U> dataType) throws DRException
	{
		return detectType(dataType.getName());
	}
	
	@SuppressWarnings("unchecked")
	public static <T extends DRIDataType<?, ?>> T detectType(final String dataType) throws DRException
	{
		Validate.notNull(dataType, "dataType must not be null");
		
		final String dataTypeLC = dataType.toLowerCase().trim();
