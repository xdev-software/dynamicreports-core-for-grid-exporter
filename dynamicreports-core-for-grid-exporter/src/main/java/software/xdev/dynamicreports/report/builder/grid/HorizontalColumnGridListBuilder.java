...
public class HorizontalColumnGridListBuilder extends AbstractBuilder<HorizontalColumnGridListBuilder, DRColumnGridList>
	implements ColumnGridComponentBuilder
{
	...
	public HorizontalColumnGridListBuilder add(final ColumnGridComponentBuilder... components)
	{
	...
	public HorizontalColumnGridListBuilder add(final HorizontalColumnGridListCellBuilder... cells)
	{
		Validate.notNull(cells, "cells must not be null");
		Validate.noNullElements(cells, "cells must not contains null cell");
		for(final HorizontalColumnGridListCellBuilder cell : cells)
		{
	...
	private HorizontalColumnGridListBuilder newRow(final ListType listType)
	{
	...
	public HorizontalColumnGridListBuilder setGap(final int gap)
	{
		this.row.setGap(gap);
		return this;
	}
	
	public HorizontalColumnGridListBuilder setVerticalGap(final int gap)
	{
