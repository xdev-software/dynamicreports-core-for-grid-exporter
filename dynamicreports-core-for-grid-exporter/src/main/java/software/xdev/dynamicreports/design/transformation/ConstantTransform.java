...
final class ConstantTransform
{
	private ConstantTransform()
	{
	}
	
	public static ResetType variableResetType(
		final Evaluation resetType,
		final DRIGroup resetGroup,
		final DesignTransformAccessor accessor)
	{
		if(resetType == null)
		{
	...
	public static DRIGroup variableResetGroup(
		final String name,
		final Evaluation resetType,
		final DRIGroup resetGroup,
		final DesignTransformAccessor accessor) throws DRException
	{
		if(resetType == null)
		{
			return null;
			...
			case COLUMN:
				if(resetGroup != null)
				{
					throw new DRException(
						"Reset group for variable " + name + " is required only for reset type BEFORE_GROUP or GROUP");
				}
				return null;
			case FIRST_GROUP:
				if(resetGroup != null)
	...
	public static EvaluationTime textFieldEvaluationTime(
		final Evaluation evaluationTime,
		final DRIGroup evaluationGroup,
		final DesignTransformAccessor accessor)
	{
	...
	public static DRIGroup textFieldEvaluationGroup(
		final Evaluation evaluationTime,
		final DRIGroup evaluationGroup,
		final DesignTransformAccessor accessor) throws DRException
	{
	...
	public static HorizontalCellComponentAlignment toHorizontalCellComponentAlignment(
		final ComponentDimensionType widthType)
	{
		if(widthType == null)
		{
			return null;
	...
	public static VerticalCellComponentAlignment toVerticalCellComponentAlignment(
		final ComponentDimensionType heightType)
	{
		if(heightType == null)
		{
			return null;
