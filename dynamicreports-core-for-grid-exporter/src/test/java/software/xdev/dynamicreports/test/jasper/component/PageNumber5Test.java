...
public class PageNumber5Test extends AbstractJasperValueTest
{
	...
	public void test()
	{
		...
		this.elementValueTest("pageFooter.textField1", "1", "2", "1");
		
		this.elementCountTest("pageFooter.textField2", 3);
		this.elementValueTest("pageFooter.textField2", " of 2", " of 2", " of 1");
		
		this.elementCountTest("pageFooter.textField3", 3);
		this.elementValueTest("pageFooter.textField3", "1", "2", "1");
		
		this.elementCountTest("pageFooter.textField4", 3);
		this.elementValueTest("pageFooter.textField4", "/2", "/2", "/1");
		
		this.elementCountTest("pageFooter.textField5", 3);
		this.elementValueTest("pageFooter.textField5", "2", "2", "1");
		
		this.elementCountTest("pageFooter.textField6", 3);
		this.elementValueTest("pageFooter.textField6", "1", "2", "1");
	}
