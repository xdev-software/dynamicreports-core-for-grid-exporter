...
class BandBackgroundTest
{
	...
	private void testBackgroundComponents(final ReportBuilder<?> rb, final Integer... radius)
	{
		try
		{
			...
			DRDesignRectangle rectangle =
				(DRDesignRectangle)((DRDesignList)report.getTitleBand().getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[0], rectangle.getRadius());
			rectangle = (DRDesignRectangle)((DRDesignList)report.getPageHeaderBand()
				.getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[1], rectangle.getRadius());
			rectangle = (DRDesignRectangle)((DRDesignList)report.getPageFooterBand()
				.getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[2], rectangle.getRadius());
			rectangle = (DRDesignRectangle)((DRDesignList)report.getColumnHeaderBand()
				.getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[3], rectangle.getRadius());
			rectangle = (DRDesignRectangle)((DRDesignList)report.getColumnFooterBand()
				.getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[4], rectangle.getRadius());
			...
			rectangle = (DRDesignRectangle)((DRDesignList)group.getHeaderBands()
				.get(0)
				.getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[5], rectangle.getRadius());
			rectangle = (DRDesignRectangle)((DRDesignList)group.getFooterBands()
				.get(0)
				.getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[6], rectangle.getRadius());
			rectangle = (DRDesignRectangle)((DRDesignList)report.getDetailBands()
				.get(0)
				.getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[7], rectangle.getRadius());
			rectangle = (DRDesignRectangle)((DRDesignList)report.getDetailBands()
				.get(1)
				.getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[8], rectangle.getRadius());
			rectangle = (DRDesignRectangle)((DRDesignList)report.getDetailBands()
				.get(2)
				.getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[9], rectangle.getRadius());
			rectangle = (DRDesignRectangle)((DRDesignList)report.getLastPageFooterBand()
				.getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[10], rectangle.getRadius());
			rectangle =
				(DRDesignRectangle)((DRDesignList)report.getSummaryBand().getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[11], rectangle.getRadius());
			rectangle = (DRDesignRectangle)((DRDesignList)report.getBackgroundBand()
				.getBandComponent()).getBackgroundComponent();
			Assertions.assertEquals(radius[12], rectangle.getRadius());
		}
