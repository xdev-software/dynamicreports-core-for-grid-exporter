...
public class Style1Test extends AbstractJasperStyleTest implements Serializable
{
	...
	protected void configureReport(final JasperReportBuilder rb)
	{
		...
		rb.columns(
				this.column1 = col.column("Column1", "field1", Integer.class).setStyle(columnStyle1),
				this.column2 = col.column("Column2", "field2", Integer.class).setStyle(columnStyle2),
				this.column3 = col.column("Column3", "field3", Integer.class).setTitleStyle(columnTitleStyle3))
