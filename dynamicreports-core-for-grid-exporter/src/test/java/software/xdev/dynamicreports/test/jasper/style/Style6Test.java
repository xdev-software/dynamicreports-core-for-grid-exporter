...
public class Style6Test extends AbstractJasperStyleTest implements Serializable
{
	...
	protected void configureReport(final JasperReportBuilder rb)
	{
		...
		rb.highlightDetailEvenRows().columns(
			...
			this.column3 = col.column("Column3", "field3", type.stringType()).setStyle(style));
	}
	...
	public void test()
	{
		...
		// column1
		this.columnDetailStyleTest(this.column1, 0, null, color1, TEST_FONT_NAME, 10f, null, null);
		this.columnDetailStyleTest(this.column1, 1, null, Color.BLUE, TEST_FONT_NAME, 10f, null, null);
		this.columnDetailStyleTest(this.column1, 2, null, color1, TEST_FONT_NAME, 10f, null, null);
		
		// column2
		this.columnDetailStyleTest(this.column2, 0, Color.BLACK, color2, TEST_FONT_NAME, 10f, null, null);
		this.columnDetailStyleTest(this.column2, 1, Color.BLACK, null, TEST_FONT_NAME, 10f, null, null);
		this.columnDetailStyleTest(this.column2, 2, Color.BLACK, color2, TEST_FONT_NAME, 10f, null, null);
		
		// column3
		this.columnDetailStyleTest(this.column3, 0, null, color3, TEST_FONT_NAME, 10f, null, null);
		this.columnDetailStyleTest(this.column3, 1, Color.BLUE, Color.WHITE, TEST_FONT_NAME, 10f, null, null);
		this.columnDetailStyleTest(this.column3, 2, null, color3, TEST_FONT_NAME, 10f, null, null);
	}
