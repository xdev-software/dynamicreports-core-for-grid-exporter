...
public class CrosstabPosition3Test extends AbstractJasperCrosstabPositionTest
{
	...
	protected void configureReport(final JasperReportBuilder rb)
	{
		...
		final CrosstabBuilder crosstab = ctab.crosstab()
			...
			.setCellHeight(20)
			.rowGroups(this.rowGroup = ctab.rowGroup(column1).setTotalHeaderHeight(30))
			.columnGroups(this.columnGroup = ctab.columnGroup(column2).setHeaderHeight(40))
	...
	public void test()
	{
		...
		this.crosstabHeaderElementPositionTest("textField1", 0, 0, 0, 100, 20);
		this.crosstabHeaderElementPositionTest("textField2", 0, 0, 20, 100, 20);
		
		// column group
		this.crosstabGroupHeaderPositionTest(this.columnGroup, 0, 0, 0, 150, 40);
		this.crosstabGroupHeaderPositionTest(this.columnGroup, 1, 0, 0, 150, 40);
		this.crosstabGroupTotalHeaderPositionTest(this.columnGroup, 0, 0, 0, 150, 40);
		
		// row group
		this.crosstabGroupHeaderPositionTest(this.rowGroup, 0, 0, 0, 100, 20);
		this.crosstabGroupHeaderPositionTest(this.rowGroup, 1, 0, 0, 100, 20);
		this.crosstabGroupHeaderPositionTest(this.rowGroup, 2, 0, 0, 100, 20);
		this.crosstabGroupTotalHeaderPositionTest(this.rowGroup, 0, 0, 0, 100, 30);
		
		// measures
		for(int i = 0; i < 6; i++)
		{
			this.crosstabCellPositionTest(this.measure1, null, null, i, 0, 0, 75, 20);
			this.crosstabCellPositionTest(this.measure2, null, null, i, 75, 0, 75, 20);
		}
		for(int i = 0; i < 3; i++)
		{
			this.crosstabCellPositionTest(this.measure1, null, this.columnGroup, i, 0, 0, 75, 20);
			this.crosstabCellPositionTest(this.measure2, null, this.columnGroup, i, 75, 0, 75, 20);
		}
		for(int i = 0; i < 2; i++)
		{
			this.crosstabCellPositionTest(this.measure1, this.rowGroup, null, i, 0, 0, 75, 30);
			this.crosstabCellPositionTest(this.measure2, this.rowGroup, null, i, 75, 0, 75, 30);
		}
		this.crosstabCellPositionTest(this.measure1, this.rowGroup, this.columnGroup, 0, 0, 0, 75, 30);
		this.crosstabCellPositionTest(this.measure2, this.rowGroup, this.columnGroup, 0, 75, 0, 75, 30);
	}
