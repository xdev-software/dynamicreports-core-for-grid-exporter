...
public class CrosstabDataset3Test extends AbstractJasperCrosstabValueTest implements Serializable
{
	...
	class MeasureExpression2 extends AbstractSimpleExpression<Double>
	{
		...
		public Double evaluate(final ReportParameters reportParameters)
		{
			...
			Assertions.assertEquals("parameter_value", reportParameters.getMasterParameters().getValue("parameter"));
			final Integer value1 = reportParameters.getValue(CrosstabDataset3Test.this.measure1);
			final Integer value2 = reportParameters.getValue(CrosstabDataset3Test.this.variable1);
			return value1.doubleValue() / value2.doubleValue();
		}
	}
}
