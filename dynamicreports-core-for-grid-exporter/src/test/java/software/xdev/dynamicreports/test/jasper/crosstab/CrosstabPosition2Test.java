...
public class CrosstabPosition2Test extends AbstractJasperCrosstabPositionTest
{
	...
	public void test()
	{
		...
		this.crosstabHeaderElementPositionTest("textField1", 0, 0, 0, 100, 16);
		
		// column group
		this.crosstabGroupHeaderPositionTest(this.columnGroup, 0, 0, 0, 150, 16);
		this.crosstabGroupHeaderPositionTest(this.columnGroup, 1, 0, 0, 150, 16);
		this.crosstabGroupTotalHeaderPositionTest(this.columnGroup, 0, 0, 0, 150, 16);
		
		// row group
		this.crosstabGroupHeaderPositionTest(this.rowGroup, 0, 0, 0, 100, 16);
		this.crosstabGroupHeaderPositionTest(this.rowGroup, 1, 0, 0, 100, 16);
		this.crosstabGroupHeaderPositionTest(this.rowGroup, 2, 0, 0, 100, 16);
		this.crosstabGroupTotalHeaderPositionTest(this.rowGroup, 0, 0, 0, 100, 16);
		
		// measures
		for(int i = 0; i < 6; i++)
		{
			this.crosstabCellPositionTest(this.measure1, null, null, i, 0, 0, 75, 16);
			this.crosstabCellPositionTest(this.measure2, null, null, i, 75, 0, 75, 16);
		}
		for(int i = 0; i < 3; i++)
		{
			this.crosstabCellPositionTest(this.measure1, null, this.columnGroup, i, 0, 0, 75, 16);
			this.crosstabCellPositionTest(this.measure2, null, this.columnGroup, i, 75, 0, 75, 16);
		}
		for(int i = 0; i < 2; i++)
		{
			this.crosstabCellPositionTest(this.measure1, this.rowGroup, null, i, 0, 0, 75, 16);
			this.crosstabCellPositionTest(this.measure2, this.rowGroup, null, i, 75, 0, 75, 16);
		}
		this.crosstabCellPositionTest(this.measure1, this.rowGroup, this.columnGroup, 0, 0, 0, 75, 16);
		this.crosstabCellPositionTest(this.measure2, this.rowGroup, this.columnGroup, 0, 75, 0, 75, 16);
	}
