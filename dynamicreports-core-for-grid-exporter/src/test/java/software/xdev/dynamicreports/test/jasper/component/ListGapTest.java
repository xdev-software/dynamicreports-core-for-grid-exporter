...
public class ListGapTest extends AbstractJasperPositionTest
{
	...
	protected void configureReport(final JasperReportBuilder rb)
	{
		rb.setPageFormat(PageType.A5)
			...
			.title(cmp.horizontalList(cmp.text("a"), cmp.text("a")).setGap(250));
	}
	...
	public void test()
	{
		...
		this.elementPositionTest("title.list1", 0, 10, 10, 401, 16);
		
		this.elementPositionTest("title.textField1", 0, 0, 0, 75, 16);
		this.elementPositionTest("title.textField2", 0, 325, 0, 76, 16);
	}
}
