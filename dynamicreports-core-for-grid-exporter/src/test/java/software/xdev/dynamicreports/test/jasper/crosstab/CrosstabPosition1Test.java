...
public class CrosstabPosition1Test extends AbstractJasperCrosstabPositionTest
{
	...
	protected void configureReport(final JasperReportBuilder rb)
	{
		...
		final CrosstabBuilder crosstab = ctab.crosstab()
			...
			.columnGroups(this.columnGroup = ctab.columnGroup(column2).setTotalHeaderWidth(210))
	...
	public void test()
	{
		...
		this.crosstabHeaderElementPositionTest("textField1", 0, 0, 0, 50, 16);
		
		// column group
		this.crosstabGroupHeaderPositionTest(this.columnGroup, 0, 0, 0, 200, 16);
		this.crosstabGroupHeaderPositionTest(this.columnGroup, 1, 0, 0, 200, 16);
		this.crosstabGroupTotalHeaderPositionTest(this.columnGroup, 0, 0, 0, 210, 16);
		
		// row group
		this.crosstabGroupHeaderPositionTest(this.rowGroup, 0, 0, 0, 50, 16);
		this.crosstabGroupHeaderPositionTest(this.rowGroup, 1, 0, 0, 50, 16);
		this.crosstabGroupHeaderPositionTest(this.rowGroup, 2, 0, 0, 50, 16);
		this.crosstabGroupTotalHeaderPositionTest(this.rowGroup, 0, 0, 0, 50, 16);
		
		// measures
		for(int i = 0; i < 6; i++)
		{
			this.crosstabCellPositionTest(this.measure1, null, null, i, 0, 0, 100, 16);
			this.crosstabCellPositionTest(this.measure2, null, null, i, 100, 0, 100, 16);
		}
		for(int i = 0; i < 3; i++)
		{
			this.crosstabCellPositionTest(this.measure1, null, this.columnGroup, i, 0, 0, 105, 16);
			this.crosstabCellPositionTest(this.measure2, null, this.columnGroup, i, 105, 0, 105, 16);
		}
		for(int i = 0; i < 2; i++)
		{
			this.crosstabCellPositionTest(this.measure1, this.rowGroup, null, i, 0, 0, 100, 16);
			this.crosstabCellPositionTest(this.measure2, this.rowGroup, null, i, 100, 0, 100, 16);
		}
		this.crosstabCellPositionTest(this.measure1, this.rowGroup, this.columnGroup, 0, 0, 0, 105, 16);
		this.crosstabCellPositionTest(this.measure2, this.rowGroup, this.columnGroup, 0, 105, 0, 105, 16);
	}
