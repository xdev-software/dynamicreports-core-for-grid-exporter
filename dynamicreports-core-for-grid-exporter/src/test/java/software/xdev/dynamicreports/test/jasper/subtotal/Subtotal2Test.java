...
public class Subtotal2Test extends AbstractJasperValueTest implements Serializable
{
	...
	protected void configureReport(final JasperReportBuilder rb)
	{
		...
		final TextColumnBuilder<String> column3;
		final TextColumnBuilder<Date> column4;
		...
		rb.setLocale(Locale.ENGLISH)
			...
			.subtotalsAtSummary(
				this.subtotal1 = sbt.sum(column1),
				this.subtotal2 = sbt.avg(column1),
				this.subtotal3 = sbt.count(column1),
				this.subtotal4 = sbt.distinctCount(column1),
				this.subtotal5 = sbt.first(column1),
				this.subtotal6 = sbt.min(column1),
				this.subtotal7 = sbt.max(column1),
				this.subtotal8 = sbt.stdDev(column1),
				this.subtotal9 = sbt.var(column1),
				
				this.subtotal10 = sbt.sum(column2),
				this.subtotal11 = sbt.avg(column2),
				this.subtotal12 = sbt.count(column2),
				this.subtotal13 = sbt.distinctCount(column2),
				this.subtotal14 = sbt.first(column2),
				this.subtotal15 = sbt.min(column2),
				this.subtotal16 = sbt.max(column2),
				this.subtotal17 = sbt.stdDev(column2),
				this.subtotal18 = sbt.var(column2),
				
				this.subtotal19 = sbt.count(column3),
				this.subtotal20 = sbt.distinctCount(column3),
				this.subtotal21 = sbt.first(column3),
				this.subtotal22 = sbt.min(column3),
				this.subtotal23 = sbt.max(column3),
				
				this.subtotal24 = sbt.count(column4),
				this.subtotal25 = sbt.distinctCount(column4),
				this.subtotal26 = sbt.first(column4),
				this.subtotal27 = sbt.min(column4),
				this.subtotal28 = sbt.max(column4));
	}
