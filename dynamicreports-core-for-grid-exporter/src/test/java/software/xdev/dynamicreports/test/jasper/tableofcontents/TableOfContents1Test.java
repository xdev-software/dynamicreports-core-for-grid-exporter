...
public class TableOfContents1Test extends AbstractJasperValueTest implements Serializable {
    ...
    protected void configureReport(final JasperReportBuilder rb) {
        ...
        rb.tableOfContents()
          ...
          .groupBy(
              this.group1 = grp.group(this.column1).footer(cmp.text("group footer").setTableOfContentsHeading(tocHeading)),
    ...
    public void test() {
        ...
        this.elementValueTest("detail.textField4", "value1", "value2", "value3", "value1", "value2", "value3", "value1", "value2", "value3");
        ...
        this.groupHeaderValueTest(this.group2, "value1", "value2", "value3", "value1", "value2", "value3", "value1", "value2", "value3");
