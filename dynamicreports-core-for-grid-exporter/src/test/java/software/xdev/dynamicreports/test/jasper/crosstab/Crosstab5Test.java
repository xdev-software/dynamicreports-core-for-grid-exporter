...
public class Crosstab5Test extends AbstractJasperCrosstabValueTest implements Serializable {
    ...
    protected void configureReport(final JasperReportBuilder rb) {
        ...
        final String expression = "$V{" + this.measure1.getName() + "}.doubleValue()/$V{" + this.measure1.getName() + "_" + this.rowGroup.getName() + "_" + this.columnGroup.getName() + "_ALL}.doubleValue() * 100";
        ...
        final CrosstabBuilder crosstab = ctab.crosstab().rowGroups(this.rowGroup).columnGroups(this.columnGroup).variables(
    ...
    private class PercentageExpression2 extends AbstractComplexExpression<BigDecimal> {
        ...
        private PercentageExpression2() {
            ...
            this.addExpression(exp.crosstabValue(Crosstab5Test.this.measure1, Crosstab5Test.this.rowGroup));
            this.addExpression(exp.jasperSyntax("$V{" + Crosstab5Test.this.measure1.getName() + "_" + Crosstab5Test.this.rowGroup.getName() + "_ALL}", Integer.class));
        }
