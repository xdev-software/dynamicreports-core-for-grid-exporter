...
public class CrosstabPosition9Test extends AbstractJasperCrosstabPositionTest
{
	...
	protected void configureReport(final JasperReportBuilder rb)
	{
		...
		this.rowGroup2 = ctab.rowGroup(column1).setShowTotal(false).setHeaderWidth(25);
		this.measure1 = ctab.measure("measure1", column3, Calculation.SUM);
		
		final CrosstabBuilder crosstab = ctab.crosstab()
			.rowGroups(this.rowGroup1, this.rowGroup2)
	...
	public void test()
	{
		...
		// row group 1
		this.crosstabGroupHeaderPositionTest(this.rowGroup1, 0, 0, 0, 100, 26);
		this.crosstabGroupHeaderPositionTest(this.rowGroup2, 0, 0, 0, 25, 26);
		
		// measures
		this.crosstabCellPositionTest(this.measure1, null, null, 0, 0, 0, 100, 26);
	}
