...
public class CrosstabPosition10Test extends AbstractJasperCrosstabPositionTest
{
	...
	protected void configureReport(final JasperReportBuilder rb)
	{
		...
		this.rowGroup1 = ctab.rowGroup(column1).setShowTotal(false);
	...
	public void test()
	{
		...
		// column group 1
		this.crosstabGroupHeaderPositionTest(this.columnGroup1, 0, 0, 0, 100, 26);
		this.crosstabGroupHeaderPositionTest(this.columnGroup1, 1, 0, 0, 100, 26);
		this.crosstabGroupTotalHeaderPositionTest(this.columnGroup1, 0, 0, 0, 100, 26);
		
		// row group 1
		this.crosstabGroupHeaderPositionTest(this.rowGroup1, 0, 0, 0, 100, 16);
		
		// measures
		this.crosstabCellPositionTest(this.measure1, null, null, 0, 0, 0, 100, 16);
		this.crosstabCellPositionTest(this.measure1, null, null, 1, 0, 0, 100, 16);
	}
