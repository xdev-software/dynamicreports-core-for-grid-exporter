...
public class CrosstabDataset1Test extends AbstractJasperCrosstabValueTest
{
	...
	protected void configureReport(final JasperReportBuilder rb)
	{
		...
		this.measure1 = ctab.measure("measure1", field5, Calculation.SUM);
		this.measure2 = ctab.measure("measure2", field5, Calculation.SUM);
		
		final CrosstabBuilder crosstab = ctab.crosstab()
			.setDataSource(this.createCrosstabDataSource())
			.headerCell(cmp.text("Header"))
			.setCellWidth(20)
			.rowGroups(this.rowGroup1 = ctab.rowGroup(field1), this.rowGroup2 = ctab.rowGroup(field2))
			.columnGroups(this.columnGroup1 = ctab.columnGroup(field3), this.columnGroup2 = ctab.columnGroup(field4))
