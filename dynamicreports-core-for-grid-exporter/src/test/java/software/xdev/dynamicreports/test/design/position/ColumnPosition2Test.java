...
public class ColumnPosition2Test extends ColumnPosition1Test
{
	...
	public void configureReport(final ReportBuilder<?> rb)
	{
		...
		final TextColumnBuilder<Integer> column4;
		final TextColumnBuilder<Integer> column5;
	...
	protected void testBand(final DRDesignBand band)
	{
		...
		this.componentPositionTest(list1, 0, 0, 575, 32);
		...
		this.componentPositionTest(list2, 191, 0, 384, 32);
		...
		this.componentPositionTest(list3, 191, 0, 384, 16);
		...
		this.componentPositionTest(list4, 191, 16, 384, 16);
		...
		// column1
		this.componentPositionTest(list1.getComponents().get(0), 0, 0, 191, 32);
		
		// column2
		this.componentPositionTest(list3.getComponents().get(0), 0, 0, 192, 16);
		
		// column3
		this.componentPositionTest(list3.getComponents().get(1), 192, 0, 192, 16);
		
		// column4
		this.componentPositionTest(list4.getComponents().get(0), 0, 0, 128, 16);
		
		// column5
		this.componentPositionTest(list4.getComponents().get(1), 128, 0, 256, 16);
	}
}
