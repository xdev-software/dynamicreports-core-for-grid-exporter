...
public class BandStyle2Test extends AbstractJasperStyleTest implements Serializable
{
	...
	protected void configureReport(final JasperReportBuilder rb)
	{
		...
		final ReportTemplateBuilder template = template().setTitleStyle(stl.style().setBackgroundColor(this.color1))
			...
			.setGroupHeaderStyle(stl.style().setBackgroundColor(this.color6))
			.setGroupFooterStyle(stl.style().setBackgroundColor(this.color7))
